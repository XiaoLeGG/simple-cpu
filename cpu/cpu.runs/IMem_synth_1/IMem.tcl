...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/csw/Desk/CS202/CPU/simple-cpu/cpu/cpu.runs/IMem_synth_1 -new_name IMem -ip [get_ips IMem]]
