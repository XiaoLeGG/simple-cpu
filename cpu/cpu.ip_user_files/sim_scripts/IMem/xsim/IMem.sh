...
#
# Generated by Vivado on Mon May 08 21:56:00 +0800 2023
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_1 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot IMem xil_defaultlib.IMem xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/csw/Xilinx/Vivado/2017.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
